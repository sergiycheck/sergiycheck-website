...
export const Text1 = React.forwardRef(
  (
    ...
    return (
      <div
        ref={ref}
        className="text-base line-clamp-3 leading-normal tracking-normal"
        {...attributes}
      >
        {children}
      </div>
...
export const Anchor1 = React.forwardRef(
  (
    ...
    return (
      <a
        ref={ref}
        className="text-base line-clamp-3 leading-normal tracking-normal font-bold"
        {...attributes}
      >
        {children}
      </a>
...
export const Title1 = React.forwardRef(
  (
    ...
    return (
      <div
        ref={ref}
        className="text-5xl line-clamp-3 leading-normal tracking-normal"
        {...attributes}
      >
        {children}
      </div>
